...
$(document).ready(function () {
    ...
    columnDefs: [
      {
        ...
        render: function (data, type, row, meta) {
          ...
          return `<div class="text-center">
							<a href="${base_url}tim_soal/edit/${data.id_tim_soal}" class="btn btn-xs btn-warning">
  ...
  table.buttons().container().appendTo("#tim_soal_wrapper .col-md-6:eq(0)");
  ...
  $("#tim_soal").on("click", ".btn-aktif", function () {
    ...
    $.ajax({
      url: base_url + "tim_soal/create_user",
      data: "id=" + id,
      type: "GET",
