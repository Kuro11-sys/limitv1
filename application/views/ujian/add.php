                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <?= form_open('ujian/save', array('id' => 'formujian'), array('method' => 'add', 'tim_soal_id' => $tim_soal->id_tim_soal, 'babak_id' => $babak->babak_id)) ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                        <input name="tgl_mulai" type="text" class="datetimepicker-input form-control" data-target="#datetimepicker1" placeholder="Tanggal Mulai">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                                        <input name="tgl_selesai" type="text" class="datetimepicker-input form-control" data-target="#datetimepicker2" placeholder="Tanggal Selesai">
...
<script src="<?= base_url() ?>assets/app/ujian/add.js"></script>
</body>
