<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data Mata Kuliah, hanya bisa diisi menggunakan ID Mata Kuliah. <a data-toggle="modal" href="#babakId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="<?= $data['babak_id'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['babak_id'] == null ? 'BELUM DIISI' : $data['babak_id'];; ?>
                                        </td>
                                    </tr>
                            <?php
                                    if ($data['nim'] == null || $data['nama_dosen'] == null || $data['email'] == null || $data['babak_id'] == null) {
                                        $status = false;
                                    }
                                endforeach;
                            }
...
<div class="modal fade" id="babakId">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="babak" class="table table-condensed table-striped">
                    <thead>
                        <th>ID</th>
                        <th>Mata Kuliah</th>
                    </thead>
