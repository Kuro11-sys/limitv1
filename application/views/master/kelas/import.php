<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data tahun, hanya bisa diisi menggunakan ID tahun. <a data-toggle="modal" href="#tahunId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="<?= $data['tahun'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['tahun'] == null ? 'BELUM DIISI' : $data['tahun'];; ?>
                                        </td>
                                    </tr>
                            <?php
                                    if ($data['kelas'] == null || $data['tahun'] == null) {
                                        $status = false;
                                    }
                                endforeach;
                            }
...
<div class="modal fade" id="tahunId">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="tahun" class="table table-condensed table-striped">
                    <thead>
                        <th>ID</th>
                        <th>tahun</th>
                    </thead>
