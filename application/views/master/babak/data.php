			...
			<div class="col-12">
				<div class="card card-primary">
					...
					<div class="card-body">
						...
						<table id="babak" class="w-100 table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th>No.</th>
									<th>Stage</th>
				...
				<div class="modal fade" id="myModal">
					<div class="modal-dialog modal-sm">
						<div class="modal-content">
							...
							<?= form_open('babak/add', array('id', 'tambah')); ?>
...
<script src="<?= base_url() ?>assets/app/master/babak/data.js"></script>
</base>
